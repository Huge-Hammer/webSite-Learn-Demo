...
//    }
    ...
    @ResponseBody
    @GetMapping(value = "pageUserInfo")
    public PageInfo<Map<String, Object>> userRole(@RequestParam(value = "offset") int current,
                                                  @RequestParam(value = "limit") int size){

        PageInfo<Map<String, Object>> pageInfo = userRoleService.listUserRole(current, size);
        return pageInfo ;
    }
    ...
    public Resp updateUser(@RequestBody UserInfo userInfo) {
